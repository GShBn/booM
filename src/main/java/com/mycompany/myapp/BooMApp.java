...
public class BooMApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(BooMApp.class);

    private final Environment env;

    public BooMApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(BooMApp.class);
